...
const LogoutConfirmModal = ({ isOpen, onClose, onConfirm, loading = false }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal Content */}
      <div className="relative bg-white rounded-2xl shadow-xl max-w-sm w-full mx-4 animate-scale-in">
        {/* Header */}
        ...
        <div className="px-6 pb-6 text-center">
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={onConfirm}
              disabled={loading}
              className="flex-1 py-2.5 px-4 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors font-medium text-sm disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
